...
/* ─── Image compression ─── */
const MAX_DIMENSION = 1024;  // GPT-4o vision works well at 1024px — keeps payload under 4MB
const JPEG_QUALITY  = 0.75;  // Sufficient for trichome detail, meaningfully smaller file size
